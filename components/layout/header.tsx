    ...
    <>
      ...
      {mobileMenuOpen && (
        <div className="fixed inset-0 z-[1000] lg:hidden animate-in fade-in duration-300">
          ...
          <div className="absolute inset-y-0 left-0 w-[85vw] max-w-[360px] bg-[#050505] flex flex-col animate-in slide-in-from-left duration-500 overflow-hidden border-r border-white/5 shadow-[20px_0_50px_rgba(0,0,0,0.8)] z-[1001]">
            {/* Menu Header */}
            <div className="p-6 border-b border-white/5 flex items-center justify-between bg-black">
              ...
              <Button size="icon" variant="ghost" className="text-zinc-500 hover:text-white hover:bg-white/5 rounded-full transition-all duration-300" onClick={() => setMobileMenuOpen(false)}>
                <X className="h-6 w-6" />
              </Button>
            </div>

            {/* Menu Links */}
            <div className="flex-1 overflow-y-auto pt-6 pb-8 px-4 custom-scrollbar">
              <div className="mb-10">
                <p className="text-[9px] font-black text-zinc-600 uppercase tracking-[0.5em] mb-6 pl-4">Navigation</p>
                {[
                  ...
                  <Link
                    ...
                    className={`flex items-center gap-4 p-4 rounded-2xl transition-all duration-300 group mb-2
                      ${pathname === item.href
              ...
              {/* Support Info */}
              <div className="mx-2 p-6 rounded-2xl bg-white/5 border border-white/5 group hover:border-orange-500/30 transition-all">
            ...
            <div className="p-6 bg-black border-t border-white/5">
              <a
                ...
                className="flex items-center justify-center gap-3 w-full bg-orange-600 hover:bg-orange-500 text-white rounded-xl py-4 shadow-xl shadow-orange-900/20 transition-all active:scale-95 group font-black uppercase tracking-widest text-xs"
              >
